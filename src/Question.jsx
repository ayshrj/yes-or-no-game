...
export const YesAnswerString = `Is the sky typically blue during the day?
Can birds fly?
Is water wet?
Is the Earth round?
...
export const NoAnswerString = `Is the sun made of paper?
...
export default {YesAnswerString, NoAnswerString};
